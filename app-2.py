    ...
    if st.session_state.radar_mode == "GEX":
        ...
        def _render_greek_ladder(lcol, src_col, ladder_title,
            ...
            with lcol:
                ...
                _cs_ladder = [
                    [0.00, cs_neg],   [0.10, cs_neg + "CC"],
                    [0.25, "#440022"], [0.40, "#220011"],
                    [0.50, T["bg"]],
                    [0.60, "#003322"], [0.75, "#004433"],
                    [0.90, cs_pos + "CC"], [1.00, cs_pos],
                ]

                # Y-labels: Strike (white) | Futures equiv
                _ylbls_l = [
                ...
                _fig_h  = max(420, min(820, _n_strikes * _cell_h + 100))
                ...
                fig_lad.update_layout(
                    ...
                    margin=dict(t=44, r=80, b=54, l=210),
                    xaxis=dict(
        ...
        # OI ladder  (open_interest per strike × DTE bucket)
        with _lad_col_oi:
            st.markdown(
                f'<div style="font-family:JetBrains Mono,monospace;'
                f'font-size:10px;font-weight:600;color:#FFFFFF;'
            ...
            if "dte" in _raw_oi.columns and "open_interest" in _raw_oi.columns:
                ...
                if _oi_strikes:
                    ...
                    _fig_h_oi  = max(420, min(820, _n_oi * _cell_h_oi + 100))
