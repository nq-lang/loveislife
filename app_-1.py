...
def dashboard():
    ...
    if st.session_state.radar_mode == "GEX":
        ...
        if df_intra.empty:
            ...
            # Key structural levels — labels on LEFT, lines span full chart
            # Using _sym_ratio consistently (same value used to place lines)
            for lvl_v, lvl_c, lvl_dash, lvl_lw, lvl_nm in [
                ...
                if y_lo_i*0.97 <= lvl_v <= y_hi_i*1.03:
                    ...
                    # LEFT-side label
                    fig_ig.add_annotation(
                        x=0.0, y=lvl_v, xref="paper", yref="y",
                        text=_ann_text,
                        showarrow=False, xanchor="right",
                        font=dict(size=8,
            ...
            fig_ig.update_layout(
                ...
                margin=dict(t=20, r=80, b=36, l=130),
                hoverlabel=dict(
